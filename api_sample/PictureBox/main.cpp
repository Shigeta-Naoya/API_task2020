...
BOOL CALLBACK MainDlgProc( HWND hDlg, UINT uMsg, WPARAM wParam, LPARAM lParam )
{
	...
	case WM_INITDIALOG:		//ダイアログ初期化(exeをダブルクリックした時)
	   ...
	   ********/
		...
		hRadioR = GetDlgItem(hDlg, IDC_RADIO1);//赤ボタンのハンドル取得ID:IDC_RADIO1
		hRadioG = GetDlgItem(hDlg, IDC_RADIO2);//緑ボタンのハンドル取得ID:IDC_RADIO2
		hRadioB = GetDlgItem(hDlg, IDC_RADIO3);//青ボタンのハンドル取得ID:IDC_RADIO3
